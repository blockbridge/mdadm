...
extern char *uuid_to_str(int id[4], int swap, char *buf, char sep);
...
extern int get_data_disks_x10(int level, int layout, int raid_disks);
...
#define dprintf(fmt, arg...) \
	fprintf(stderr, "%s%s: %s: "fmt, Name, Name_suffix, __func__, ##arg)
#define dprintf_cont(fmt, arg...) \
	fprintf(stderr, fmt, ##arg)
#else
#define dprintf(fmt, arg...) \
        ({ if (0) fprintf(stderr, "%s%s: %s: " fmt, Name, Name_suffix, __func__, ##arg); 0; })
#define dprintf_cont(fmt, arg...) \
...
#ifdef DEBUG
#define pr_err(fmt, args...) fprintf(stderr, "%s%s: %s: "fmt, Name, Name_suffix, __func__, ##args)
#else
#define pr_err(fmt, args...) fprintf(stderr, "%s%s: "fmt, Name, Name_suffix, ##args)
#endif
